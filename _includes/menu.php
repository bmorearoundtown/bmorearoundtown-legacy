...
<div class="nav-select hidden-xs visible-sm visible-md hidden-lg">
	...
	<select onchange="location = this.options[this.selectedIndex].value;">
		...
		<option value="/testimonials">Testimonials</option>
           <option value="http://baltimoresocial.com/">Social Sports</option>
...
<!-- 					<li class="divider"></li>
				...
				<ul class="dropdown-menu" role="menu">
					<li class="dropdown-header">Social Sports</li>
					<li><a target="_blank" href="http://baltimoresocial.com/">BMORE Social Sports</a></li>
				</ul>
